...
output "k8s_internet_gateway_access_route_table_id" {
  ...
  value       = module.k8s.k8s_internet_gateway_access_route_table_id
}
...
output "k8s_nat_gateway_access_route_table_id" {
  ...
  value       = module.k8s.k8s_nat_gateway_access_route_table_id
}
...
output "k8s_public_control_plane_security_group_ids" {
  ...
  value       = module.k8s.k8s_public_control_plane_security_group_ids
}
...
output "k8s_private_control_plane_security_group_ids" {
  ...
  value       = module.k8s.k8s_private_control_plane_security_group_ids
}
...
output "k8s_public_worker_node_security_group_ids" {
  ...
  value       = module.k8s.k8s_public_worker_node_security_group_ids
}
...
output "k8s_private_worker_node_security_group_ids" {
  ...
  value       = module.k8s.k8s_private_worker_node_security_group_ids
}
...
output "k8s_key_pair_key_name" {
  ...
  value       = module.k8s.k8s_key_pair_key_name
}
...
output "k8s_public_control_planes" {
  ...
  value       = module.k8s.k8s_public_control_planes
}
...
output "k8s_private_control_planes" {
  ...
  value       = module.k8s.k8s_private_control_planes
}
...
output "k8s_public_worker_nodes" {
  ...
  value       = module.k8s.k8s_public_worker_nodes
}
...
output "k8s_private_worker_nodes" {
  ...
  value       = module.k8s.k8s_private_worker_nodes
}
